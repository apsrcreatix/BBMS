...
const use_chemical_url = base_url + Config.PATHS.useChemicals;

interface UseChemicalProps {
  open: boolean;
  passed: any;
  onClose: any;
}

export default class UseChemical extends React.Component<UseChemicalProps> {
  state = {
