...
const add_kit_url = base_url + Config.PATHS.addKits;
...
export default class AddKit extends React.Component<AddKitProps> {
  state = {
    ...
    return (
      ...
      >
        <form onSubmit={this.handleSubmit}>
          <DialogTitle id="confirmation-dialog-title">Use Kits</DialogTitle>
          <DialogContent>
            <div>
              <p>
